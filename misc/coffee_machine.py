...
existing_resources = {
    ...
    "coffee": 500,
    "milk": 1000,
    "money": 0.0,  # Start with 0 money in the machine
}
        ...
        while powered_on:
            def process_transaction():
                ...
                if payment["total"] >= selected_drink["price"]:
                    ...
                    # Deduct the price from the total inserted money and increment profit
                    change = payment["total"] - selected_drink["price"]

                    # Update the machine's money (profit)
                    existing_resources["money"] += selected_drink["price"]
                    profit += selected_drink["price"]  # Increment total profit
            ...
            if selection in drinks:
                ...
                # Display a report of the remaining resources and total money
                ...
                print("Powering off ...")
                powered_on = False  # Exit the loop
            else:
